...
public class GetTwitterStream {
    ...
    static UserStreamListener listener = new UserStreamListener() {
        ...
        @Override
        public  void onUnfollow(User u, User ue) {
        ...
        @Override
        public  void onRetweetedRetweet(User var1, User var2, Status var3) {
            System.out.println("");
        }
        @Override
        public  void onFavoritedRetweet(User var1, User var2, Status var3) {
            System.out.println("");
        }

        @Override
        public  void onQuotedTweet(User var1, User var2, Status var3) {
            System.out.println("");
        }
